...
public class CardController {
	...
	@RequestMapping(value = "/api/v1/addtocard", method = RequestMethod.POST,
	...
	@RequestMapping(value = "/api/v1/addtocard", method = RequestMethod.PUT,
			consumes = MediaType.APPLICATION_JSON_VALUE, produces = MediaType.APPLICATION_JSON_VALUE)
	...
	@RequestMapping(value = "/api/v1/addtocard", method = RequestMethod.DELETE,
			consumes = MediaType.APPLICATION_JSON_VALUE, produces = MediaType.APPLICATION_JSON_VALUE)
